...
if (isset($_GET['act']))
{
	...
	if ($act == 'supload')
	{
    	...
    	echo '<div class="all"><div class="menu"><div class="text"><div class="title">Upload</div>';
  ...
  unlink("avatars/".$u_id.".gif");
	...
	elseif ($act == 'upload')
    {
    	...
    	echo '<div class="all"><div class="menu"><div class="text"><div class="title">Upload</div>';
    	echo "<div class='c'>Загружаем аватар(ваш аватар будет сжат до 100x100 px. Загружать можно только .gif файлы)<br/><form action='http://".$_SERVER['HTTP_HOST']."/upan/aadd.php?act=supload' method='post' enctype='multipart/form-data'>";
...
';
echo '<div class="c">
<a href="http://'.$_SERVER['HTTP_HOST'].'/upan/aadd.php?act=upload">Upload</a><br />
</div>';
